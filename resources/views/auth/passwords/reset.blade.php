	...
	<div class="row display-flex">
		<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12">
          ...
          Now with a touch of socialization and Gamification.
				...
				<a href="/login" class="btn btn-md btn-border c-white" style="background-color:white;">Register Now!</a>
			</div>
		</div>
		...
		<div class="col-xl-5 col-lg-6 col-md-12 col-sm-12 col-xs-12">
			<div class="registration-login-form" style="min-height:200px!important;">
              ...
              <form class="content" role="form" method="POST" action="{{ url('/password/reset') }}">
             ...
             {{ csrf_field() }}
                  ...
                  <div class="form-group2 label-floating is-empty" style="margin-bottom:25px;">
                    ...
                    <input id="password" type="password" class="form-control2" name="password" required>
                  </div>

                  <div class="form-group2 label-floating is-empty" style="margin-bottom:25px;">
                    <label class="control-label">Confirm Password</label>
                    <input id="password_confirm" type="password" class="form-control2" name="password_confirmation" required>
                  </div>
									<button type="submit" class="btn btn-lg full-width" style="background-color:#3a94ff;color:white!important;">Change Password</button>
