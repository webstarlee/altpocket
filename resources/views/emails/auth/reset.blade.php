						...
						<tr>
							<td align="center" valign="top" style="padding-bottom: 40px;" class="imgHero">
								...
								<a href="#" target="_blank" style="text-decoration:none;">
									<img src="https://altpocket.io/img/email/key.png" width="600" alt="" border="0" style="width:100%; max-width:600px; height:auto; display:block;">
								</a>
							</td>
						</tr>
            ...
            <tr>
							<td align="center" valign="top" style="padding-bottom:40px;padding-left:20px;padding-right:20px;" class="description">
								...
								<p class="midText" style="color:#919191; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; line-height:22px; text-align:center; padding:0; margin:0;">
									Click on the button below to reset your password, if you have no requested to reset your password, not further action is required.
								</p>
							</td>
						</tr>
            ...
            <tr>
							<td align="center" valign="top" style="padding-bottom:40px;padding-left:20px;padding-right:20px;" class="btnCard">
								...
								<table align="center" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td align="center" class="postButton" style="background-color:rgb(79,197,234);padding-top:10px;padding-bottom:10px;padding-left:25px;padding-right:25px;border-radius:2px">
											<!-- Button Link // -->
											<a href="https://altpocket.io/password/reset/{{$token}}" target="_blank" style="color:#FFFFFF; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:12px; font-weight:600; letter-spacing:1px; line-height:20px; text-transform:uppercase; text-decoration:none; display:block;" >
												Reset Password
											</a>
										</td>
									</tr>
						...
						<tr>
							<td align="center" valign="top" style="padding-bottom:40px;padding-left:20px;padding-right:20px;" class="description">
								...
								<p class="midText" style="color:#313131; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; line-height:20px; text-align:center; padding:0; margin:0;">
									Or using this Link: <a href="https://altpocket.io/password/reset/{{$token}}" target="_blank" style="color:#75c5ec">https://altpocket.io/password/reset/{{$token}}</a>
								</p>
							</td>
						</tr>
