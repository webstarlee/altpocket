...
<head>
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<title>New Follower on Altpocket</title>
						...
						<tr>
							<td align="center" valign="top" style="padding-bottom: 20px; padding-left: 20px; padding-right: 20px;" class="subTitle">
								...
								<h4 class="midTitle" style="color:#919191; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:18px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:26px; text-align:center; padding:0; margin:0;">
									<a href="https://altpocket.io/user/{{$notification['username']}}">{{$notification['username']}}</a> has started following you!
								</h4>
							</td>
						</tr>
								...
								<table align="center" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td align="center" class="postButton" style="background-color:rgb(79,197,234);padding-top:10px;padding-bottom:10px;padding-left:25px;padding-right:25px;border-radius:2px">
											<!-- Button Link // -->
											<a href="https://altpocket.io/user/{{$notification['username']}}" target="_blank" style="color:#FFFFFF; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:12px; font-weight:600; letter-spacing:1px; line-height:20px; text-transform:uppercase; text-decoration:none; display:block;" >
