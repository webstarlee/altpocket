  ...
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<style type="text/css">
		...
		*{-webkit-text-size-adjust:none;-webkit-text-resize:100%;text-resize:100%;}
		...
		img, a img{border:0; height:auto; outline:none; text-decoration:none;max-width:80%;}
    ...
    .CToWUd{max-width:80%; height:auto; }
	</style>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout:fixed;background-color:#F9F9F9;" id="bodyTable">
	<tbody><tr>
						...
						<tbody><tr>
							<td align="center" valign="middle" style="padding-top:40px;padding-bottom:40px">
								...
								<a href="#" target="_blank" style="text-decoration:none;" class="">
									<img src="https://altpocket.io/assets/logo_blue_text.png" alt="" width="180" border="0" style="height:auto; display:block;" class="">
								</a>
							</td>
						</tr>
					</tbody></table>
		...
		<table border="0" cellpadding="0" cellspacing="0" style="max-width:600px;" width="100%" class="wrapperTable">
			<tbody><tr>
				<td align="center" valign="top">
					<!-- Card Table Open // -->
					<table border="0" cellpadding="0" cellspacing="0" style="background-color: rgb(255, 255, 255); box-shadow: rgb(216, 216, 216) 0px 0px 10px; border: 1px solid rgb(238, 238, 238);" width="100%" class="oneColumn">
						<!-- Header Border // -->
						<tbody><tr>
							<td class="topBorder" height="3" style="background-color: rgb(79, 197, 234); font-size: 1px; line-height: 3px;">&nbsp;</td>
						</tr>
						...
						<tr>
							<td align="center" valign="top" style="padding-bottom: 40px;" class="imgHero">
								...
								<a href="#" target="_blank" style="text-decoration:none;">
									<img src="https://altpocket.io/img/email/statement.png" width="600" alt="" border="0" style="width:100%; max-width:600px; height:auto; display:block;">
								</a>
							</td>
						</tr>
						...
						<tr>
							<td align="center" valign="top" style="padding-bottom: 20px; padding-left: 20px; padding-right: 20px;" class="subTitle">
								...
								<h4 class="midTitle" style="color:#919191; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:18px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:26px; text-align:center; padding:0; margin:0;">
									Help us take Altpocket to the next level.
								</h4>
							</td>
						</tr>
  ...
  <td align="center" valign="top" style="padding-bottom:40px;padding-left:20px;padding-right:20px;" class="description">
    ...
    <p class="midText" style="color:#919191; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; line-height:22px; text-align:center; padding:0; margin:0;">
      The recent growth in Altpocket users has been stunning - 19 days into December and we’ve almost doubled the amount of users we had in November. Thank you so much for this.
      However, we feel we can do even more - we want to expand our team, start pushing updates to you faster, and accelerate the development of our mobile app; and you can help us do it.<br><br>
    A fortunate opportunity has arisen, whereby if Altpocket manages to raise $12,000 through our community, our incubator will step in and give us over $24,000. This would enable us to do things way beyond what we are currently capable of.<br>
      <br>
We’ve now made it possible for you to help us raise the $12,000 through opening up the pre-purchase of our Premium Membership, slated for release in Q1 of 2018. See the link below for more information on what benefits you would receive and what we’ve got planned for the future.    </p>
  </td>
</tr>
						...
						<tr>
							<td align="center" valign="top" style="padding-bottom: 40px; padding-left: 20px; padding-right: 20px;" class="description">
								<!-- Comment Text // -->
								<p class="midText" style="color:#313131; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:18px; font-weight:400; line-height:22px; text-align:center; padding:0; margin:0;">					</p>
							</td>
						</tr>
						...
						<tr>
							<td align="center" valign="top" style="padding-bottom: 40px; padding-left: 20px; padding-right: 20px;" class="btnCard">
								...
								<table align="center" border="0" cellpadding="0" cellspacing="0">
									<tbody><tr>
										<td align="center" class="postButton" style="background-color: rgb(79,197,234); padding: 10px 25px; border-radius: 2px;">
											<!-- Button Link // -->
											<a href="https://altpocket.io/raise" target="_blank" style="color:#FFFFFF; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:12px; font-weight:600; letter-spacing:1px; line-height:20px; text-transform:uppercase; text-decoration:none; display:block;">
												Take me to Pre-Purchase
											</a>
										</td>
									</tr>
								</tbody></table>
		...
		<table border="0" cellpadding="0" cellspacing="0" style="max-width:600px;" width="100%" class="wrapperTable">
			<tbody><tr>
				<td align="center" valign="top">
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%" class="footer">
						<tbody><tr>
							<td align="center" valign="top" style="padding-top:10px;padding-bottom:10px;padding-left:10px;padding-right:10px;" class="socialLinks">
								...
								<a href="https://www.facebook.com/Altpocket.io/" target="_blank" style="display:inline-block;" class="facebook">
									<img src="http://grapestheme.com/notify/img/social/facebook.png" alt="" width="40" border="0" style="height:auto;margin:2px">
								</a>
								<!-- Social Links (Twitter)// -->
								<a href="https://twitter.com/altpocket" target="_blank" style="display:inline-block;" class="twitter">
								...
								<a href="https://www.instagram.com/altpocket.io/" target="_blank" style="display:inline-block;" class="instagram">
                  ...
                  <a href="https://docs.google.com/document/d/1kmPggYBodjUzAllo-T-mZR4UTxSQ-Bq9dTSioOvo3rY/edit" style="color: rgb(79, 197, 234); text-decoration: none;" target="_blank">Privacy Policy</a> | <a href="https://altpocket.io/support" style="color: rgb(79, 197, 234); text-decoration: none;" target="_blank">Support</a> | <a href="https://discord.gg/YzdgGjG" style="color: rgb(79, 197, 234); text-decoration: none;" target="_blank">Discord Server</a>
								</p>
							</td>
						</tr>
						...
						<tr>
							<td align="center" valign="top" style="padding: 10px;" class="brandInfo">
								...
								<p class="smlText" style="color:#313131; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:11px; font-weight:400; line-height:18px; text-align:center; margin:0; padding:0;">
									This email was sent to you by Altpocket AB. You are receiving this email because you are registered on Altpocket.&nbsp;<br> If you wish to unsubscribe from all future emails, please disable email notifications in your settings.<br>


									<br>Altpocket AB, | Nohabsgatan 18A | 46153, Trollhättan | Sweden
								</p>
							</td>
						</tr>
