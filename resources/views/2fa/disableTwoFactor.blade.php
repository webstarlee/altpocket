			...
			<div class="registration-login-form" style="padding-left:0px!important;min-height:0;">
				...
				<div class="tab-content">
					<div class="tab-pane active" id="profile" role="tabpanel" data-mh="log-tab">
						<div class="title h6">Disable 2FA on your account</div>
						<form class="content" role="form" method="POST" action="/2fa/disable" style="text-align:center;">
            <p>To disable 2FA on your account you need to enter the 2FA code displayed in your application.</p>
            <br /><br />
             {{ csrf_field() }}
