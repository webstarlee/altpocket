...
<div class="container">
	<div class="row display-flex">
		...
		<div class="col-xl-5 col-lg-6 col-md-12 col-sm-12 col-xs-12">
			<div class="registration-login-form" style="padding-left:0px!important;">

				<!-- Tab panes -->
				<div class="tab-content">
					<div class="tab-pane active" id="profile" role="tabpanel" data-mh="log-tab">
						<div class="title h6">Enable 2FA on your account</div>
						<form class="content" role="form" method="POST" action="/2fa/enable" style="text-align:center;">
            <p>Open up your 2FA mobile app and scan the following QR barcode:</p>
            <br />
            <img alt="Image of QR barcode" src="{{$image}}"  style="display:block;margin:0 auto;"/>
            <br />
            If your 2FA mobile app does not support QR barcodes,
            enter in the following number: <code>{{ $secret }}</code><br><br>
            Then enter the code displayed in your application below:
            <br /><br />
              ...
              <input type="text" style="display:none" name="secret" value="{{$secret}}">
							<div class="row">
								<div class="col-xl-12 col-lg-12 col-md-12">
									...
									<button type="submit" class="btn btn-lg full-width" style="background-color:#3a94ff;color:white!important;">Enable</button>
								</div>
							</div>
						</form>
					</div>
