...
<head>
	...
	<title>Altpocket - 404 Error </title>
		...
		<div class="row">
			<div class="col-xl-6 m-auto col-lg-6 col-md-12 col-sm-12 col-xs-12">
				<div class="page-404-content">
					<img src="/version3/img/404.png" alt="photo">
					<div class="crumina-module crumina-heading align-center">
						<h2 class="h1 heading-title">A <span class="c-primary" style="color:#3a94ff!important;">wild ghost</span> appears! Sadly, not what you were looking for...</h2>
						<p class="heading-text">Sorry! The page you were looking for has been moved, doesn't exist or currently has an issue.
							If you like, you can return to our dashboard, or if the problem persists, send us an email to: <a href="#" style="color:#3a94ff!important;">edwin@altpocket.io</a>
						</p>
					</div>
