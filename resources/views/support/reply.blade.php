  ...
  <div class="row" style="margin-right:0px!important;">
    <div class="col-md-4 col-md-offset-4">
      <div class="contact-form">
        <form action="/reply/{{$answer->id}}" role="form" method="post">
         {{ csrf_field() }}
          <div class="form-group">
            <label for="sel1">Reply *</label>
            <textarea name="message" id="message" cols="30" rows="10" class="form-control" placeholder="Write your reply here."></textarea>
          </div>
          <button type="submit" class="themeix-btn hover-bg">Reply to {{$u->username}}</button>
        </form>
      </div>
    </div>
  </div>
