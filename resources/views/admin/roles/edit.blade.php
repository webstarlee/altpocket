              ...
              <div class="m-dropdown__body">
                <div class="m-dropdown__content">
                  <ul class="m-nav">
                    ...
                    <li class="m-nav__item">
                      <a href="/admin/roles/create" class="m-nav__link">
                    ...
                    <li class="m-nav__item">
                      <a href="/admin/roles/assign" class="m-nav__link">
          ...
          {{csrf_field()}}
					<div class="m-portlet__body">
						<div class="form-group m-form__group row">
							<div class="col-lg-6">
								...
								<input type="text" class="form-control m-input" placeholder="Enter a name" name="name" value="{{$role->name}}" required>
							...
							<div class="col-lg-6">
								...
								<input type="text" class="form-control m-input" placeholder="Enter a title" name="title" value="{{$role->title}}" required>
								<span class="m-form__help">
						...
						<div class="form-group m-form__group row">
							<div class="col-lg-6">
								...
								<div class="m-input-icon m-input-icon--right">
									<input type="text" class="form-control m-input" placeholder="Enter a description" name="description" value="{{$role->description}}">
								</div>
								<span class="m-form__help">
							...
							<div class="col-lg-6">
								...
								<div class="m-input-icon m-input-icon--right">
                  <input class="form-control m-input" type="color" @if($role->color != "") value="{{$role->color}}" @else value="#ffffff" @endif id="example-color-input" style="height: 37px;" name="color">
								</div>
								<span class="m-form__help">
            ...
            <div class="form-group m-form__group row">
                  ...
                  <label class="m-radio m-radio--solid">
                    <input type="radio" name="type" @if($role->type == "Default") checked @endif value="Default">
                    Default
                    <span></span>
                  </label>
                  <label class="m-radio m-radio--solid">
                    <input type="radio" name="type" @if($role->type == "Rank") checked @endif value="Rank">
                    Rank
                    <span></span>
                  </label>
                  <label class="m-radio m-radio--solid">
										<input type="radio" name="type" @if($role->type == "Staff") checked @endif value="Staff">
										Staff
										<span></span>
									</label>
									<label class="m-radio m-radio--solid">
										<input type="radio" name="type" value="Donator" @if($role->type == "Donator") checked @endif>
										Donator
										<span></span>
									</label>
								</div>
                ...
                <div class="m-input-icon m-input-icon--right">
                  <input type="text" name="style" class="form-control m-input" placeholder="font-weight:600;..." value="{{$role->style}}">
                </div>
                <span class="m-form__help">
                ...
                <div>
                  <select class="form-control m-bootstrap-select m_selectpicker" name="emblem" style="padding-right:0px!important;">
                    ...
                    @foreach($emblems as $emblem)
                      <option data-content="<img src='/awards/{{$emblem->emblem}}'> {{$emblem->title}}" value="{{$emblem->emblem}}" @if($role->title == $emblem->title) selected @endif>
                      {{$emblem->title}}
                      </option>
                    @endforeach
                  </select>
              ...
              <div class="col-lg-12">
                ...
                @foreach($permissions as $perm)
                  ...
                  <div class="col-3">
                    <span class="m-switch">
                      <label>
                        <input type="checkbox" name="permissions[]" value="{{$perm->name}}" @if($role->hasPermissionTo($perm)) checked @endif>
                        <span></span>
                      </label>
                    </span>
                  </div>
