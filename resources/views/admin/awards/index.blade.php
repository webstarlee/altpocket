...
@section('title', 'Admin | List Badges')
              ...
              <div class="m-dropdown__body">
                <div class="m-dropdown__content">
                  <ul class="m-nav">
                    ...
                    <li class="m-nav__item">
                      <a href="/admin/badges/create" class="m-nav__link">
                    ...
                    <li class="m-nav__item">
                      <a href="/admin/badges/assign" class="m-nav__link">
			...
			<div class="m-portlet__head-caption">
				<div class="m-portlet__head-title">
					<h3 class="m-portlet__head-text">
						List badges
						<small>
							All available badges on Altpocket.
						</small>
					</h3>
				</div>
			</div>
			...
			<div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
				<div class="row align-items-center">
					...
					<div class="col-xl-4 order-1 order-xl-2 m--align-right">
						<a href="/admin/badges/create" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
							<span>
...
@section('js')
		<script src="/panel/assets/demo/default/custom/components/datatables/base/data-ajax-badges.js?version=1222" type="text/javascript"></script>
    ...
    $(".delete-permission").click(function(){
      ...
      swal({
        ...
        if(inputValue == "I Understand") {
          window.location.replace('/admin/badges/delete/'+id);
        }
      });
    });
  })
