                            ...
                            <ul class="nav navbar-nav pull-right">
                                <li class="dropdown avatar-menu">
                                    ...
                                    <ul class="dropdown-menu btn-primary dropdown-menu-right">
                                        <li><a href="/user/{{Auth::user()->username}}"><i class="zmdi zmdi-account"></i> Profile</a></li>
                                        <li><a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="zmdi zmdi-sign-in"></i> Logout</a></li>
                                    </ul>
                                </li>
                    ...
                    <div class="sidebar-inner sidebar-push">
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            @if(Auth::user())
                                ...
                                <li @if( Route::currentRouteName()=='group.explore' ||
                                     Route::currentRouteName()=='group.single.view' ||
                                     Route::currentRouteName()=='group.single.view.about' ||
                                     Route::currentRouteName()=='group.single.view.members' ||
                                     Route::currentRouteName()=='group.single.view.blocked' ||
                                     Route::currentRouteName()=='group.single.view.photos') class="active" @endif ><a href="{{route('group.explore')}}"><i class="fa fa-users"></i>Group</a></li>{{--assassin--}}
                                ...
                                <li class="nav-dropdown">
                                    <a href="#"><i class="zmdi zmdi-trending-up"></i>My Investments</a>
        							<ul class="nav-sub">
                                            ...
                                            @if($investment->sold_at == null)
                                                @if($investment->market == "BTC")
                                                    ...
                                                    <li><a href="javascript:void(0)">
                                                        ...
                                                        {{$investment->currency}} <span @if($profit > 0) style="color:#73c04d;" @else style="color:#de6b6b" @endif>({!! $symbol !!}{{number_format($profit, $decimal1)}}{!! $symbol2 !!})</span>
                                                        </a>
                                                    </li>
                                                @endif
                                ...
                                <li class="nav-dropdown">
                                    <a href="#"><i class="zmdi zmdi-help"></i>Support</a>
                    				<ul class="nav-sub">
                                ...
                                <li><a href="#" id="secret-message"><i class="fa fa-heart" style="color:#ef5350"></i>Support Us</a></li>
        ...
        <div class="modal fade" id="secret_modal" tabindex="-1" role="dialog" aria-labelledby="secret_modal">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>
                            Thank you for considerating a donation. We strongly believe in Altpocket and that's we quit our jobs to work on it fulltime.
                            <br>
