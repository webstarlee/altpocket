                    ...
                    <li class="nav-dropdown"><a href="#"><i class="zmdi zmdi-trending-up"></i>My Investments</a>
							...
							<ul class="nav-sub">
								...
								<li><a href="/investments2/"><i class="zmdi zmdi-folder"></i> Investments 2.0 (BETA)</a></li>
                                  @foreach(DB::table('manual_investments')->where([['userid', '=', Auth::user()->id], ['sold_at', '=', null]])->get() as $investment)
                                    <?php
                                        ...
                                        $image = DB::table('cryptos')->where('symbol', $investment->currency)->first()->name;

                                     ?>

                                     <li><a href="https://coinmarketcap.com/currencies/{{$image}}">
                                  ...
                                  @foreach(DB::table('polo_investments')->where([['userid', '=', Auth::user()->id], ['sold_at', '=', null]])->get() as $investment)
                                      ...
                                      <?php
                                          ...
                                          if(DB::table('cryptos')->where('symbol', $investment->currency)->exists())
                                          {
                                            $image = DB::table('cryptos')->where('symbol', $investment->currency)->first()->name;
                                          } else {
                                            $image = "";
                                  ...
                                  @foreach(DB::table('bittrex_investments')->where([['userid', '=', Auth::user()->id], ['sold_at', '=', null]])->get() as $investment)
                                    @if($investment->market == "BTC")
                                    <?php
