...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var _listItems = __webpack_require__(19);
	
	var _photoSwipe = __webpack_require__(20);
	
	var _mail = __webpack_require__(21);
	
	var _chips = __webpack_require__(22);
	
	var _stepper = __webpack_require__(23);
	
	var _panelExpand = __webpack_require__(24);
	
	var _auth = __webpack_require__(25);
	
	var _cal = __webpack_require__(26);
	
	var _alerts = __webpack_require__(28);
	
	var _notes = __webpack_require__(29);
	...
	var _matchElementHeight = __webpack_require__(32);
	...
	var _dataTables = __webpack_require__(36);
	
	var _wizard = __webpack_require__(37);
	
	var _gmap = __webpack_require__(38);
	
	var _sidebarChat = __webpack_require__(39);
	
	var _contacts = __webpack_require__(40);
	
	var _task = __webpack_require__(41);
	
	var _ecom = __webpack_require__(42);
	
	var _fileManager = __webpack_require__(43);
	...
	$(function () {
	  ...
	  (0, _panelExpand.activeAccordion)();
...
/***/ function(module, exports) {
	...
	var backDrops = exports.backDrops = function backDrops(className, element, $target) {
	  ...
	  if ($target.hasClass(className)) {
	    ...
	    if ($('.backdrop').length > 0 && !$body.hasClass('backdrop-open')) {
...
/***/ function(module, exports) {
	...
	var toggleCard = function toggleCard() {
	  $('input#toggle-price:checkbox').change(function () {
	    if ($(this).is(":checked")) {
...
/***/ function(module, exports) {
	...
	var dashboardWebStats = function dashboardWebStats() {
	    ...
	    for (var i = 0; i <= 10; i += 1) {
	        uploads.push([i, parseInt(Math.random() * 13)]);
	    }
	    var downloads = [];
	    for (var i = 0; i <= 10; i += 1) {
	        downloads.push([i, parseInt(Math.random() * 13)]);
	    }
...
/***/ function(module, exports) {
	...
	var formExpand = function formExpand() {
...
/***/ function(module, exports) {
	...
	var initPhotoSwipeFromDOM = exports.initPhotoSwipeFromDOM = function initPhotoSwipeFromDOM() {
	  ...
	  $('#photo-gallery figure a').click(function (event) {
...
/***/ function(module, exports) {
	...
	exports.activeAccordion = activeAccordion;
...
/***/ function(module, exports) {
	...
	var registerForm = function registerForm() {
	    $('[data-toggle="register"]').click(function (e) {
	        e.stopPropagation();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _filterList = __webpack_require__(27);
	...
	var cal = function cal() {
	  ...
	  target.fullCalendar({
	    ...
	    events: [{
	      ...
	      start: '2017-03-02T10:30:00.000Z',
	      end: '2017-03-02T12:30:00.000Z',
	      allDay: false,
	      className: 'mw-salmon',
	      ...
	      start: '2017-03-05T08:30:00',
	      end: '2017-03-05T12:00:00',
	      allDay: false,
	      ...
	      start: '2017-03-13T11:30:00',
	      end: '2017-03-13T14:30:00',
	      allDay: false,
	      className: 'mw-blue',
	  ...
	  $(document).on('click', '#btn_add_event', function () {
	    ...
	    // var start = moment(addEventStartDate).toISOString();
	    // var end = moment(addEventEndDate).toISOString();
	    ...
	    // }
	    //var test1 = moment(addEventStartDate + " " + addEventStartTime).format("YYYY-MM-DD[T]HH:mm:ss");
	    //var test0 = addEventStartDate + " " + addEventStartTime;
	    //var format = moment(test0).toISOString();
	    //var test1 = moment(test0).toISOString();
	    // var eventStart  = parseMDYA(test1);
	    // var test2 = addEventEndDate + " " + addEventEndTime;
	    // var eventEnd = parseMDYA(test2);
	
	    // var sd = moment(addEventStartDate),
	    //     ed = moment(addEventEndDate),
	    //     st = moment(addEventStartTime, 'h:mm a').format('H:mm'),
	    //     et = moment(addEventEndTime, 'h:mm a').format('H:mm');
	...
	var updateInputCal = function updateInputCal() {
	  ...
	  $('input#toggle-allDay:checkbox').change(function () {
	    if ($(this).is(":checked")) {
	...
	var addInputCal = function addInputCal() {
	  ...
	  $('input#allDay:checkbox').change(function () {
	    if ($(this).is(":checked")) {
...
/***/ function(module, exports) {
	...
	var sweetAlerts = function sweetAlerts() {
	    $('.sweet-error').on('click', function (e) {
	        e.stopPropagation();
	        swal("Oops...", "Something went wrong!", "error");
	    });
	    $('.sweet-message').on('click', function (e) {
	        e.stopPropagation();
	        swal("Here's simple message!");
	    });
	    $('.sweet-success').on('click', function (e) {
	        e.stopPropagation();
	        swal("Good job!", "You clicked the button!", "success");
	    });
	    $('.sweet-warning').on('click', function (e) {
	        e.stopPropagation();
	        swal({
	            title: "Are you sure?",
	    ...
	    $('.sweet-warning-cancel').on('click', function (e) {
	        e.stopPropagation();
	        swal({
	            title: "Are you sure?",
	            text: "You will not be able to recover this imaginary file!",
	    ...
	    $('.sweet-timer').on('click', function (e) {
	        e.stopPropagation();
	        swal({
	...
	var alertifyjs = function alertifyjs() {
	    ...
	    $('#custom-label').on('click', function (e) {
	        e.stopPropagation();
...
/***/ function(module, exports) {
	...
	var notesAdd = function notesAdd() {
	  ...
	  $('#note_form .card-actions li.dropdown').click(function (e) {
	    $(this).toggleClass('open');
	    e.stopPropagation();
	  });
