...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	$(function () {
	  ...
	  (0, _autocomplete.autoCompleteAltpocket)();
...
/***/ function(module, exports) {
	...
	var materialDatePicker = function materialDatePicker() {
	  ...
	  $('#md_input_date2').bootstrapMaterialDatePicker({ weekStart: 0, time: false });
	  $('#md_input_date3').bootstrapMaterialDatePicker({ weekStart: 0, time: false });
	  $('#md_input_date4').bootstrapMaterialDatePicker({ weekStart: 0, time: false });
	  $('#md_input_date5').bootstrapMaterialDatePicker({ weekStart: 0, time: false });
...
/***/ function(module, exports) {
	...
	var autoCompleteAltpocket = function autoCompleteAltpocket() {

		$.get( "/get/coins", function( data ) {
		  var coinsArray = data;
			$('#autocomplete_coins').typeahead({
					source: coinsArray
			});
			$('#autocomplete_coins_mining').typeahead({
					source: coinsArray
			});
		});
	};
	...
	var autocompleteBasic = function autocompleteBasic() {
	    var statesArray = [ 'Bitcoin', 'Ethereum', 'Ripple', 'Litecoin', 'NEM', 'Dash', 'Ethereum Classic', 'Monero', 'Stellar Lumens', 'Steem', 'Golem', 'Augur', 'Dogecoin', 'MaidSafeCoin', 'Stratis', 'Zcash', 'Gnosis', 'Waves', 'BitShares', 'Bytecoin', 'DigixDAO', 'Factom', 'Decred', 'SingularDTV', 'Ardor', 'Siacoin', 'GameCredits', 'PIVX', 'Tether', 'Lisk', 'Peercoin', 'Iconomi', 'BitConnect', 'Nxt', 'Byteball', 'iExec RLC', 'Namecoin', 'FirstBlood', 'SysCoin', 'Round', 'Emercoin', 'NEO', 'Komodo', 'Storjcoin X', 'TokenCard', 'Melon', 'Gulden', 'Nexus', 'Lykke', 'Ark', 'Counterparty', 'Xaurum', 'Wings', 'BitBay', 'BitcoinDark', 'Bitcrystals', 'YbCoin', 'NAV Coin', 'WeTrust', 'DigiByte', 'BlackCoin', 'EarthCoin', 'PotCoin', 'ZCoin', 'Synereo', 'Bankcoin', 'Chronobank', 'ZClassic', 'Creditbit', 'Matchpool', 'Agoras Tokens', 'Swarm City', 'Ubiq', 'VPNCoin', 'Rubycoin', 'Vertcoin', 'Clams', 'Global Currency Reserve', 'I/O Coin', 'LBRY Credits', 'Edgeless', 'Skycoin', 'Novacoin', 'Crown', 'MonaCoin', 'Nexium', 'vSlice', 'GridCoin', 'Expanse', 'FedoraCoin', 'Asch', 'Blocknet', 'Waves Community Token', 'Primecoin', 'Burst', 'ION', 'Radium', 'Bitcoin Plus', 'Pascal Coin', 'MonetaryUnit', 'Omni', 'Viacoin', 'Lunyr', 'NautilusCoin', 'BelaCoin', 'SolarCoin', 'HEAT', 'Pepe Cash', 'SIBCoin', 'LoMoCoin', 'Megacoin', 'Feathercoin', 'VeriCoin', 'PoSW Coin', 'NeosCoin', 'Aeon', 'Gambit', 'Shift', 'Energycoin', 'Darcrus', 'Golos', 'Infinitecoin', 'CageCoin', 'Incent', 'PinkCoin', 'FairCoin', 'FirstCoin', 'AsiaCoin', 'FlorinCoin', 'E-Dinar Coin', 'Veros', 'MergeCoin', 'WorldCoin', 'Vcash', 'Auroracoin', 'ShadowCash', 'DNotes', 'SpreadCoin', 'Einsteinium', 'SaluS', 'Janus', 'XtraBYtes', 'ReddCoin', 'Digitalcoin', 'Unobtanium', 'FoldingCoin', 'CloakCoin', 'Pluton', 'Sphere', 'DubaiCoin', 'Safe Exchange Coin', 'Yocoin', 'Riecoin', 'ZcCoin', 'OBITS', 'Quark', 'Arcade Token', 'Zennies', 'CureCoin', 'Bitmark', 'Steem Dollars', 'OKCash', 'TransferCoin', 'CryptoCarbon', 'Diamond', 'GoldCoin', 'BoostCoin', 'vTorrent', 'bitCNY', 'DigitalNote', 'BitSend', 'DeepWebCash', 'Verge', 'Cryptonite', 'Wild Beast Block', 'Groestlcoin', 'Atmos', 'Boolberry', 'TagCoin', 'Project Decorum', 'SecureCoin', 'Centurion', 'Inpay', 'Rise', 'Bitpark Coin', 'Startcoin', 'Tickets', 'LuckChain', 'ChainCoin', 'Adzcoin', 'Sequence', 'Dynamic', 'Bata', 'iCash', 'Espers', 'HunterCoin', 'Zetacoin', 'InsaneCoin', 'bitUSD', 'RaiBlocks', 'ICO OpenLedger', 'Mercury', 'Mintcoin', 'Spectrecoin', 'ArtByte', 'Asiadigicoin', 'MediterraneanCoin', 'Musicoin', 'Breakout', 'MaxCoin', 'Hacker Gold', 'Veltor', 'AudioCoin', 'e-Gulden', 'Myriad', 'HiCoin', 'Bitland', 'Blitzcash', 'PutinCoin', 'Qwark', 'CasinoCoin', 'Ixcoin', 'Circuits of Value', 'EvergreenCoin', 'BitBean', 'TrumpCoin', 'Stealthcoin', 'TileCoin', 'GeoCoin', 'Unitus', 'VeriumReserve', 'Tokes', 'Environ', 'Elcoin', 'Fantomcoin', 'ExclusiveCoin', '2GIVE', 'CannabisCoin', 'Voxels', 'Capricoin', 'KoreCoin', 'Atomic Coin', 'UniBURST', 'Terracoin', 'Syndicate', 'Vault Coin', 'Synergy', 'TrustPlus', 'Rimbit', 'Deutsche eMark', 'Magi', 'NuShares', 'Moin', 'MazaCoin', 'PostCoin', 'Master Swiscoin', 'ProCurrency', 'Virtacoinplus', 'I0Coin', 'Orbitcoin', 'WhiteCoin', 'Xiaomicoin', 'DopeCoin', 'SmartCoin', 'HempCoin', 'Hush', 'Jewels', 'Renos', 'Pesobit', 'PepeCoin', 'PRCoin', 'NuBits', 'TeslaCoin', 'Bytecent', 'GuccioneCoin', 'ParkByte', 'Quatloo', 'FuelCoin', 'Dotcoin', 'Happycoin', 'Zero', 'DT Token', '8Bit', 'Torcoin', 'GameUnits', '1337', 'Kobocoin', 'Karbowanec', 'Influxcoin', 'MTMGaming', 'Coin(O)', 'AmsterdamCoin', 'Sexcoin', 'Sterlingcoin', 'MojoCoin', 'Machinecoin', 'PipCoin', 'bitEUR', 'Elementrem', 'Piggycoin', 'UnbreakableCoin', 'PureVidz', 'bitBTC', 'Wyvern', 'CrevaCoin', 'GAIA', 'Pascal Lite', 'LanaCoin', 'Triangles', 'Zoin', 'Sprouts', 'Titcoin', 'Cryptojacks', 'KiloCoin', 'Kurrent', 'Eryllium', 'MiloCoin', 'Allion', 'bitSilver', 'Hexx', 'Honey', 'Cannacoin', 'Independent Money System', '42-coin', 'Freicoin', 'Ratecoin', 'Acoin', 'Gapcoin', 'Wexcoin', 'Darsek', 'MACRON', 'Blakecoin', 'ICOBID', 'GlobalBoost-Y', 'HoboNickels', 'NevaCoin', 'Cannabis Industry Coin', 'LevoPlus', 'Bikercoin', 'bitGold', 'BeaverCoin', 'Solaris', 'PayCon', 'Argus', 'TajCoin', 'Eurocoin', 'Solarflarecoin', 'ParallelCoin', 'Ebittree Coin', 'Marijuanacoin', 'Beatcoin', 'Bitvolt', 'FuzzBalls', 'BenjiRolls', 'JIO Token', 'Coinonat', 'Elysium', 'Gold Pressed Latinum', 'SnakeEyes', 'SuperNET', 'Scotcoin', 'Jinn', 'MUSE', 'Mooncoin', 'InstantDEX', 'Ethereum Movie Venture', 'Zeitcoin', 'BlockPay', 'Breakout Stake', 'Triggers', 'Colossuscoin V2', 'Visio', 'Pangea Poker', 'Woodcoin', 'DubaiCoin (DBIC)', 'SATOSHICARD', 'EuropeCoin', 'Pandacoin', 'Casino', 'Tao', 'Ultimate Secure Cash', 'BitBar', 'Qora', 'GlobalCoin', 'Pesetacoin', 'E-Currency Coin ', 'BTSR', 'Canada eCoin', 'HTMLCOIN', 'Bitswift', 'Mineum', 'Dashcoin', 'YashCoin', 'Carboncoin', 'Digital Rupees', 'The Cypherfunks', 'ReeCoin', 'RussiaCoin', 'Joincoin', 'BTCtalkcoin', 'LottoCoin', 'CoExistCoin', 'BlueCoin', 'SwagBucks', 'LTBcoin', 'Trollcoin', 'DigitalPrice', 'HitCoin', 'Rubies', 'HOdlcoin', 'Shorty', 'Bitcore', 'NobleCoin', 'Tattoocoin (Standard Edition)', 'Bitcurrency', 'Cryptofund', 'Rare Pepe Party', 'Tristar Coin', 'IncaKoin', 'Crypto Bullion', 'BritCoin', 'GoldBlocks', 'Ripto Bux', 'Flycoin', 'Bitstar', 'Bitz', 'LiteDoge', 'Netko', 'NetCoin', 'Swing', 'MarteXcoin', 'BillaryCoin', 'PayCoin', 'Pulse', 'C-Bit', 'Anoncoin', 'FlutterCoin', 'Pakcoin', 'NeuCoin', 'NoLimitCoin', 'SmileyCoin', 'LiteBar', 'MetalCoin', 'BTCDragon', 'Neutron', 'Stress', 'QuazarCoin', 'ChessCoin', 'TEKcoin', 'KarmaToken', 'BERNcash', 'Bottlecaps', 'Eternity', 'PetroDollar', 'Francs', 'Truckcoin', 'GCoin', 'KushCoin', 'WayGuide', 'Fastcoin', 'Artex Coin', 'AmberCoin', 'UFO Coin', 'CCMiner', '808Coin', 'Granite', 'Greencoin', 'MustangCoin', 'Yacoin', 'Zayedcoin', 'Phoenixcoin', 'Evotion', 'CorgiCoin', 'RevolverCoin', 'Dollarcoin', 'Lex4All', 'TittieCoin', 'Nyancoin', 'DigiCube', 'Chronos', 'SproutsExtreme', 'Argentum', 'HyperStake', 'FujiCoin', 'Philosopher Stones', 'Emerald Crypto', 'BigUp', 'SatoshiMadness', 'SpaceCoin', 'AurumCoin', 'Evil Coin', 'Grantcoin', 'GoldPieces', 'AquariusCoin', 'Debitcoin', 'PlatinumBAR', 'Horizon', 'RedCoin', 'Guncoin', 'BipCoin', 'Universe', 'Prime-XI', 'Coin2.1', 'Bitcloud', 'Sativacoin', 'Joulecoin', 'CryptoWorldX Token', 'Impact', 'Dobbscoin', 'BiosCrypto', 'PX', 'UniCoin', 'HealthyWormCoin', 'UCoin', 'BunnyCoin', 'Crypto', 'Uro', 'BurstOcean', 'Creatio', 'CryptoEscudo', 'Dreamcoin', 'AgrolifeCoin', 'X-Coin', 'Franko', 'Cypher', 'FlavorCoin', 'Firecoin', 'Newbium', 'RonPaulCoin', 'Unrealcoin', 'PonziCoin', 'Bolivarcoin', 'BumbaCoin', 'Jin Coin', 'IslaCoin', 'Sling', 'Magnum', 'Zurcoin', 'SecretCoin', 'WMCoin', 'Vector', 'Destiny', 'Tigercoin', 'OctoCoin', 'SoonCoin', 'Luna Coin', 'ARbit', 'Halcyon', 'PopularCoin', 'SongCoin', 'VapersCoin', 'GanjaCoin', 'SixEleven', 'Hommalicoin', 'Bitzeny', 'Prototanium', 'Flaxscript', 'Universal Currency', 'Aricoin', 'VirtualCoin', 'Alexium', 'AntiBitcoin', 'LeaCoin', 'VIP Tokens', 'Steps', 'Blackstar', 'OsmiumCoin', 'Orlycoin', 'GameBet Coin', 'GPU Coin', 'BlazeCoin', 'Money', 'Qibuck', 'NewYorkCoin', 'Spots', 'Dix Asset', 'MindCoin', 'Speedcash', 'LetItRide', 'Photon', 'BitQuark', 'PIECoin', 'Ride My Car', 'WARP', 'DAPPSTER', 'B3Coin', 'Iconic', 'PLNcoin', 'AnarchistsPrime', 'GetGems', 'Comet', 'G3N', 'Cabbage', 'High Voltage', 'Bitcoin 21', 'Kittehcoin', 'EGO', 'BowsCoin', 'Abncoin', 'Future Digital Currency', 'TAGRcoin', 'Metal Music Coin', 'JobsCoin', 'Printerium', 'PosEx', 'Scorecoin', 'Hirocoin', 'AllSafe', 'iBank', 'BitTokens', 'Zonecoin', 'SydPak', 'DPAY', 'Antilitecoin', 'Xonecoin', '1CRedit', 'ImpulseCoin', 'BioBar', 'Litecred', 'Rawcoin', 'Californium', 'Save and Gain', 'Concoin', 'Cashcoin', 'Revenu', 'NodeCoin', 'GeertCoin', 'Guarany', 'Shilling', 'Enigma', 'Impeachcoin', 'Selfiecoin', 'P7Coin', 'Dollar Online', 'Zcashshare', 'Powercoin', 'HamRadioCoin', 'SwapToken', 'Mbitbooks', 'Doubloon', 'Digital Credits', 'CRTCoin', 'PizzaCoin', 'Xenixcoin', 'Cashout', 'World Gold Coin', 'CaliphCoin', 'MikeTheMug', 'BTCGold', 'Soarcoin', '23 Skidoo', 'Internet of Things', 'AMIS', 'Bitcoin Unlimited (Futures)', 'NxttyACCI', 'Malcoin', 'Forevercoin', 'GoldUnionCoin', 'Fargocoin', 'E-coin', 'Altcoin', 'Internet of People', 'XDE II', 'Yogold', 'Pioneershares', 'TeslaCoilCoin', 'DynamicCoin', 'TaaS', 'Decent (Pre-Launch)', 'Bitgem', 'TechShares', 'Databits', 'Zilbercoin', 'GAYcoin', 'LEOcoin', 'Tattoocoin (Limited Edition)', 'Topaz Coin', 'TROPTIONS', 'ClubCoin', 'EB3 Coin', 'WA Space', 'DIBCOIN', 'Pabyosi Coin (Special)', 'Golos Gold', 'AlpaCoin', 'Tyrocoin', 'DeusCoin', 'Wowecoin', 'InvisibleCoin', 'Fazzcoin', 'AxFunds', 'WavesGo', 'LeCoin', 'Digitalfund', 'CryptoBuck', 'Omicron', 'EDRCoin', 'Elacoin', 'President Johnson', 'DeltaCredits', 'RHFCoin', 'Avoncoin', 'LandCoin', 'Lepaoquan', 'Mind Gene', 'IvugeoCoin', 'International Diamond', 'PiCoin', 'ShellPay', 'KolschCoin', 'GBCGoldCoin', 'Sharkcoin', 'ZSEcoin', 'Dashs', 'CHNCoin', 'Psilocybin', 'President Trump', 'Bitcoin Scrypt', 'First Bitcoin', 'GoldReserve', 'Opal', 'EggCoin', 'Xaucoin', 'MMXVI', 'UltraCoin', 'BagCoin', 'RoyalCoin 2', 'netBit', 'TodayCoin', 'BitcoinFast', 'AvatarCoin', 'Helleniccoin', 'Mavro', 'Quotient', 'UtaCoin', 'Clinton', 'TrickyCoin', 'GameLeagueCoin', 'CBD Crystals', 'RichCoin', 'TeraCoin', 'OCOW', 'Alphabet Coin Fund', 'President Sanders', 'WeAreSatoshi', 'Motocoin', 'Grumfork', 'BestChain', 'Bitcedi', 'RoyalCoin', 'VGINA', 'Digital Bullion Gold', 'UR', 'The Aladin', 'Advanced Internet Blocks', 'Neptune Classic', 'Condensate', 'Skeincoin', 'True Investment Coin', 'Dubstep', 'RubleBit', 'SportsCoin', 'KashhCoin', 'FrankyWillCoin', 'Opescoin', 'Braincoin', 'Quebecoin', 'Cubits', 'T-coin', 'Vsync', 'BlazerCoin', 'GoldMaxCoin', 'Gambleo', 'BitAlphaCoin', 'Lazaruscoin', 'MarxCoin', 'Operand', 'Sakuracoin', 'UGAIN', 'The Vegan Initiative', 'Happy Creator Coin', 'PrismChain', 'AsicCoin', 'DarkLisk', 'Cycling Coin', 'Moneta', 'LAthaan', 'MobileCash', 'TheCreed', 'PinkDog', 'LePen', 'BigLifeCoin', 'LinkedCoin', 'Devcoin', 'Victoriouscoin', 'TeamUp', 'PayPeer', 'Wowcoin', 'MoneyCoin', 'InflationCoin', 'FedoraShare', 'UNCoin', 'PokeCoin', 'Rcoin', 'SoulCoin', 'President Clinton', 'FireFlyCoin', 'CyberCoin', 'X2', 'Aces', 'Cashme', 'SuperTurboStake', 'Safe Trade Coin', 'Global Business Revolution', 'VegasCoin', 'ChoofCoin', 'Yescoin', 'Valorbit', 'Tellurion', 'PabyosiCoin', 'Dimecoin', 'Virtacoin', 'BitCentavo', 'XP', 'Paccoin', 'Bond', 'Unity Ingot', 'BCAP', 'Humaniq', 'Crave', 'FUNCoin', 'iTicoin', '9COIN', 'Minereum', 'Cannation', 'Creativecoin', 'Etheroll', 'InsaneCoin', 'Aragon', 'PRIZM', 'Axiom', 'Gycoin', 'RouletteToken', 'QTUM (Pre-Launch)', 'EcoCoin', 'EquiTrader', 'SlimCoin', 'XCurrency', 'RabbitCoin', 'Digital Money Bits', 'APX', 'Quartz', 'MCAP', 'CacheCoin', 'StrongHands', 'Theresa May Coin', 'Sumokoin', 'ZenGold', 'OBITS.WARRANT', 'Project-X', 'ZenCash', 'Ethbits', 'Aeternity (Pre-Launch)', 'SuperCoin', 'KibiCoin', 'Version', 'Donationcoin', 'IrishCoin', 'Basic Attention Token', 'Metaverse Entropy', 'eBoost', 'OHM Wallet', 'Aidos Kuneen', 'Karmacoin', 'STEX', 'Patientory', 'Quantum', 'QubitCoin', 'ZetaMicron', 'Veritaseum', 'Electra', 'Quantum Resistant Ledger', 'CryptoForecast', 'EncryptoTel', 'MobileGo', 'Ammo Rewards', 'Peerplays', 'Neuro', 'Putin Classic', 'IOTA', 'Mysterium', 'Legends Room', 'Linx', 'Adelphoi', 'Bancor', 'SafeCoin', 'Golfcoin', 'Cheapcoin', 'Cofound.it', 'CryptCoin', 'GlobalToken', 'SHACoin', 'microCoin', 'Numeraire', 'AllSafe', 'Octanox', 'Cthulhu Offerings', 'Rare Pepe Party', 'SONM', 'ZrCoin', 'VOISE', 'iDice', 'Unify', 'Elastic', 'Coupecoin', 'MIYUCoin', 'Bitok', 'KingN Coin', 'EMoneyPower', 'Dinastycoin', 'Footy Cash', 'LeviarCoin (Pre-Launch)', 'Onix', 'Bitcoin Planet', 'BetaCoin', 'Animecoin', 'ELcoin', 'Tychocoin', 'GXShares', 'Good Karma', 'ATC Coin', 'Antimatter', 'Bitradio', 'Catcoin', 'Flash', 'Pirate Blocks', 'TenX', 'Status', 'Marscoin', 'ChanCoin', 'Ergo', 'BriaCoin', 'CompuCoin', 'PutinCoin', 'FIMKrypto', 'EOS', 'Alphabit', 'Kayi', 'Sync', 'TurboCoin', 'AdEx', 'Denarius', 'Remicoin', 'Voyacoin', 'Bongger', 'Storj', 'BnrtxCoin', 'SocialCoin', 'Monaco', 'CryptoPing', 'Useless Ethereum Token', 'Wagerr', 'E4ROW', 'Slevin', 'Ecobit', 'UniversalRoyalCoin', 'Polybius', 'SunContract (Pre-Launch)', 'Greencoin', 'JetCoin', 'Metal', 'WomenCoin', 'ICO', 'Virta Unique Coin', 'Bitdeal', 'NVO', 'Falcoin', 'DaxxCoin', 'FuturXe', 'Rupee', 'FinCoin', 'Global Tour Coin', 'TradecoinV2', 'PeepCoin', 'OperaCoin', 'Sovereign Hero', 'Populous', 'MantraCoin', 'Santiment Network Token', 'OmiseGo', 'TerraNova', 'CVCoin', 'Rialto', 'Linda', 'Embers', 'MiyuCoin', 'FuckToken', 'Civic', 'Bitquence', 'Bit20', 'Starta', 'DHG', 'Link Platform', 'RSGPcoin', 'CoEval', 'BitCoal', 'LiteBitcoin', 'Link Platform', 'FutCoin', 'Particl', 'Primulon', 'DraftCoin', 'SmartCash', 'BBQCoin', 'DAS', 'Primulon', 'SkinCoin', 'Fonziecoin', 'SOILcoin', 'ToaCoin', 'Pillar', 'Royalties', 'Signatum', 'Coimatic 2.0', 'OracleChain', 'Binance Coin', '300 Token', 'Primalbase', 'CampusCoin', 'EmberCoin', 'PeopleCoin', 'InsureX', 'GeyserCoin', 'Mothership', 'Birds', 'Regacoin', '020LondonCoin', 'Cream', 'BlakeStar', 'KekCoin', 'OpenAnx', 'Bitcoin Cash', 'Monkey', 'Compcoin', 'district0x', 'FundYourselfNow (Pre-Launch)', 'FiboCoins', 'Fuda Energy', 'HBCoin'];
	    $('#autocomplete_states').typeahead({
	        source: statesArray
	    });
	    $('#autocomplete_states2').typeahead({
	        source: statesArray
	    });
	    $('#autocomplete_states3').typeahead({
	        source: statesArray
	    });
	};
	var autocompleteClear = function autocompleteClear() {
	    var statesArray = [ 'Bitcoin', 'Ethereum', 'Ripple', 'Litecoin', 'NEM', 'Dash', 'Ethereum Classic', 'Monero', 'Stellar Lumens', 'Steem', 'Golem', 'Augur', 'Dogecoin', 'MaidSafeCoin', 'Stratis', 'Zcash', 'Gnosis', 'Waves', 'BitShares', 'Bytecoin', 'DigixDAO', 'Factom', 'Decred', 'SingularDTV', 'Ardor', 'Siacoin', 'GameCredits', 'PIVX', 'Tether', 'Lisk', 'Peercoin', 'Iconomi', 'BitConnect', 'Nxt', 'Byteball', 'iExec RLC', 'Namecoin', 'FirstBlood', 'SysCoin', 'Round', 'Emercoin', 'AntShares', 'Komodo', 'Storjcoin X', 'TokenCard', 'Melon', 'Gulden', 'Nexus', 'Lykke', 'Ark', 'Counterparty', 'Xaurum', 'Wings', 'BitBay', 'BitcoinDark', 'Bitcrystals', 'YbCoin', 'NAV Coin', 'WeTrust', 'DigiByte', 'BlackCoin', 'EarthCoin', 'PotCoin', 'ZCoin', 'Synereo', 'Bankcoin', 'Chronobank', 'ZClassic', 'Creditbit', 'Matchpool', 'Agoras Tokens', 'Swarm City', 'Ubiq', 'VPNCoin', 'Rubycoin', 'Vertcoin', 'Clams', 'Global Currency Reserve', 'I/O Coin', 'LBRY Credits', 'Edgeless', 'Skycoin', 'Novacoin', 'Crown', 'MonaCoin', 'Nexium', 'vSlice', 'GridCoin', 'Expanse', 'FedoraCoin', 'Asch', 'Blocknet', 'Waves Community Token', 'Primecoin', 'Burst', 'ION', 'Radium', 'Bitcoin Plus', 'Pascal Coin', 'MonetaryUnit', 'Omni', 'Viacoin', 'Lunyr', 'NautilusCoin', 'BelaCoin', 'SolarCoin', 'HEAT', 'Pepe Cash', 'SIBCoin', 'LoMoCoin', 'Megacoin', 'Feathercoin', 'VeriCoin', 'PoSW Coin', 'NeosCoin', 'Aeon', 'Gambit', 'Shift', 'Energycoin', 'Darcrus', 'Golos', 'Infinitecoin', 'CageCoin', 'Incent', 'PinkCoin', 'FairCoin', 'FirstCoin', 'AsiaCoin', 'FlorinCoin', 'E-Dinar Coin', 'Veros', 'MergeCoin', 'WorldCoin', 'Vcash', 'Auroracoin', 'ShadowCash', 'DNotes', 'SpreadCoin', 'Einsteinium', 'SaluS', 'Janus', 'XtraBYtes', 'ReddCoin', 'Digitalcoin', 'Unobtanium', 'FoldingCoin', 'CloakCoin', 'Pluton', 'Sphere', 'DubaiCoin', 'Safe Exchange Coin', 'Yocoin', 'Riecoin', 'ZcCoin', 'OBITS', 'Quark', 'Arcade Token', 'Zennies', 'CureCoin', 'Bitmark', 'Steem Dollars', 'OKCash', 'TransferCoin', 'CryptoCarbon', 'Diamond', 'GoldCoin', 'BoostCoin', 'vTorrent', 'bitCNY', 'DigitalNote', 'BitSend', 'DeepWebCash', 'Verge', 'Cryptonite', 'Wild Beast Block', 'Groestlcoin', 'Atmos', 'Boolberry', 'TagCoin', 'Project Decorum', 'SecureCoin', 'Centurion', 'Inpay', 'Rise', 'Bitpark Coin', 'Startcoin', 'Tickets', 'LuckChain', 'ChainCoin', 'Adzcoin', 'Sequence', 'Dynamic', 'Bata', 'iCash', 'Espers', 'HunterCoin', 'Zetacoin', 'InsaneCoin', 'bitUSD', 'RaiBlocks', 'ICO OpenLedger', 'Mercury', 'Mintcoin', 'Spectrecoin', 'ArtByte', 'Asiadigicoin', 'MediterraneanCoin', 'Musicoin', 'Breakout', 'MaxCoin', 'Hacker Gold', 'Veltor', 'AudioCoin', 'e-Gulden', 'Myriad', 'HiCoin', 'Bitland', 'Blitzcash', 'PutinCoin', 'Qwark', 'CasinoCoin', 'Ixcoin', 'Circuits of Value', 'EvergreenCoin', 'BitBean', 'TrumpCoin', 'Stealthcoin', 'TileCoin', 'GeoCoin', 'Unitus', 'VeriumReserve', 'Tokes', 'Environ', 'Elcoin', 'Fantomcoin', 'ExclusiveCoin', '2GIVE', 'CannabisCoin', 'Voxels', 'Capricoin', 'KoreCoin', 'Atomic Coin', 'UniBURST', 'Terracoin', 'Syndicate', 'Vault Coin', 'Synergy', 'TrustPlus', 'Rimbit', 'Deutsche eMark', 'Magi', 'NuShares', 'Moin', 'MazaCoin', 'PostCoin', 'Master Swiscoin', 'ProCurrency', 'Virtacoinplus', 'I0Coin', 'Orbitcoin', 'WhiteCoin', 'Xiaomicoin', 'DopeCoin', 'SmartCoin', 'HempCoin', 'Hush', 'Jewels', 'Renos', 'Pesobit', 'PepeCoin', 'PRCoin', 'NuBits', 'TeslaCoin', 'Bytecent', 'GuccioneCoin', 'ParkByte', 'Quatloo', 'FuelCoin', 'Dotcoin', 'Happycoin', 'Zero', 'DT Token', '8Bit', 'Torcoin', 'GameUnits', '1337', 'Kobocoin', 'Karbowanec', 'Influxcoin', 'MTMGaming', 'Coin(O)', 'AmsterdamCoin', 'Sexcoin', 'Sterlingcoin', 'MojoCoin', 'Machinecoin', 'PipCoin', 'bitEUR', 'Elementrem', 'Piggycoin', 'UnbreakableCoin', 'PureVidz', 'bitBTC', 'Wyvern', 'CrevaCoin', 'GAIA', 'Pascal Lite', 'LanaCoin', 'Triangles', 'Zoin', 'Sprouts', 'Titcoin', 'Cryptojacks', 'KiloCoin', 'Kurrent', 'Eryllium', 'MiloCoin', 'Allion', 'bitSilver', 'Hexx', 'Honey', 'Cannacoin', 'Independent Money System', '42-coin', 'Freicoin', 'Ratecoin', 'Acoin', 'Gapcoin', 'Wexcoin', 'Darsek', 'MACRON', 'Blakecoin', 'ICOBID', 'GlobalBoost-Y', 'HoboNickels', 'NevaCoin', 'Cannabis Industry Coin', 'LevoPlus', 'Bikercoin', 'bitGold', 'BeaverCoin', 'Solaris', 'PayCon', 'Argus', 'TajCoin', 'Eurocoin', 'Solarflarecoin', 'ParallelCoin', 'Ebittree Coin', 'Marijuanacoin', 'Beatcoin', 'Bitvolt', 'FuzzBalls', 'BenjiRolls', 'JIO Token', 'Coinonat', 'Elysium', 'Gold Pressed Latinum', 'SnakeEyes', 'SuperNET', 'Scotcoin', 'Jinn', 'MUSE', 'Mooncoin', 'InstantDEX', 'Ethereum Movie Venture', 'Zeitcoin', 'BlockPay', 'Breakout Stake', 'Triggers', 'Colossuscoin V2', 'Visio', 'Pangea Poker', 'Woodcoin', 'DubaiCoin', 'SATOSHICARD', 'EuropeCoin', 'Pandacoin', 'Casino', 'Tao', 'Ultimate Secure Cash', 'BitBar', 'Qora', 'GlobalCoin', 'Pesetacoin', 'E-Currency Coin ', 'BTSR', 'Canada eCoin', 'HTMLCOIN', 'Bitswift', 'Mineum', 'Dashcoin', 'YashCoin', 'Carboncoin', 'Digital Rupees', 'The Cypherfunks', 'ReeCoin', 'RussiaCoin', 'Joincoin', 'BTCtalkcoin', 'LottoCoin', 'CoExistCoin', 'BlueCoin', 'SwagBucks', 'LTBcoin', 'Trollcoin', 'DigitalPrice', 'HitCoin', 'Rubies', 'HOdlcoin', 'Shorty', 'Bitcore', 'NobleCoin', 'Tattoocoin (Standard Edition)', 'Bitcurrency', 'Cryptofund', 'Rare Pepe Party', 'Tristar Coin', 'IncaKoin', 'Crypto Bullion', 'BritCoin', 'GoldBlocks', 'Ripto Bux', 'Flycoin', 'Bitstar', 'Bitz', 'LiteDoge', 'Netko', 'NetCoin', 'Swing', 'MarteXcoin', 'BillaryCoin', 'PayCoin', 'Pulse', 'C-Bit', 'Anoncoin', 'FlutterCoin', 'Pakcoin', 'NeuCoin', 'NoLimitCoin', 'SmileyCoin', 'LiteBar', 'MetalCoin', 'BTCDragon', 'Neutron', 'Stress', 'QuazarCoin', 'ChessCoin', 'TEKcoin', 'KarmaToken', 'BERNcash', 'Bottlecaps', 'Eternity', 'PetroDollar', 'Francs', 'Truckcoin', 'GCoin', 'KushCoin', 'WayGuide', 'Fastcoin', 'Artex Coin', 'AmberCoin', 'UFO Coin', 'CCMiner', '808Coin', 'Granite', 'Greencoin', 'MustangCoin', 'Yacoin', 'Zayedcoin', 'Phoenixcoin', 'Evotion', 'CorgiCoin', 'RevolverCoin', 'Dollarcoin', 'Lex4All', 'TittieCoin', 'Nyancoin', 'DigiCube', 'Chronos', 'SproutsExtreme', 'Argentum', 'HyperStake', 'FujiCoin', 'Philosopher Stones', 'Emerald Crypto', 'BigUp', 'SatoshiMadness', 'SpaceCoin', 'AurumCoin', 'Evil Coin', 'Grantcoin', 'GoldPieces', 'AquariusCoin', 'Debitcoin', 'PlatinumBAR', 'Horizon', 'RedCoin', 'Guncoin', 'BipCoin', 'Universe', 'Prime-XI', 'Coin2.1', 'Bitcloud', 'Sativacoin', 'Joulecoin', 'CryptoWorldX Token', 'Impact', 'Dobbscoin', 'HempCoin', 'BiosCrypto', 'PX', 'UniCoin', 'HealthyWormCoin', 'UCoin', 'BunnyCoin', 'Crypto', 'Uro', 'BurstOcean', 'Creatio', 'CryptoEscudo', 'Dreamcoin', 'AgrolifeCoin', 'X-Coin', 'Franko', 'Cypher', 'FlavorCoin', 'Firecoin', 'Newbium', 'RonPaulCoin', 'Unrealcoin', 'PonziCoin', 'Bolivarcoin', 'BumbaCoin', 'Jin Coin', 'IslaCoin', 'Sling', 'Magnum', 'Zurcoin', 'SecretCoin', 'WMCoin', 'Vector', 'Destiny', 'Tigercoin', 'OctoCoin', 'SoonCoin', 'Luna Coin', 'ARbit', 'Halcyon', 'PopularCoin', 'SongCoin', 'VapersCoin', 'GanjaCoin', 'SixEleven', 'Hommalicoin', 'Bitzeny', 'Prototanium', 'Flaxscript', 'Universal Currency', 'Aricoin', 'VirtualCoin', 'Alexium', 'AntiBitcoin', 'LeaCoin', 'VIP Tokens', 'Steps', 'Blackstar', 'OsmiumCoin', 'Orlycoin', 'GameBet Coin', 'GPU Coin', 'BlazeCoin', 'Money', 'Qibuck', 'NewYorkCoin', 'Spots', 'Dix Asset', 'MindCoin', 'Speedcash', 'LetItRide', 'Photon', 'BitQuark', 'PIECoin', 'Ride My Car', 'WARP', 'DAPPSTER', 'B3Coin', 'Iconic', 'PLNcoin', 'AnarchistsPrime', 'GetGems', 'Comet', 'G3N', 'Cabbage', 'High Voltage', 'Bitcoin 21', 'Kittehcoin', 'EGO', 'BowsCoin', 'Abncoin', 'Future Digital Currency', 'TAGRcoin', 'Metal Music Coin', 'JobsCoin', 'Printerium', 'PosEx', 'Scorecoin', 'Hirocoin', 'AllSafe', 'iBank', 'BitTokens', 'Zonecoin', 'SydPak', 'DPAY', 'Antilitecoin', 'Xonecoin', '1CRedit', 'ImpulseCoin', 'BioBar', 'Litecred', 'Rawcoin', 'Californium', 'Save and Gain', 'Concoin', 'Cashcoin', 'Revenu', 'NodeCoin', 'GeertCoin', 'Guarany', 'Shilling', 'Enigma', 'Impeachcoin', 'Selfiecoin', 'P7Coin', 'Dollar Online', 'Zcashshare', 'Powercoin', 'HamRadioCoin', 'SwapToken', 'Mbitbooks', 'Doubloon', 'Digital Credits', 'CRTCoin', 'PizzaCoin', 'Xenixcoin', 'Cashout', 'World Gold Coin', 'CaliphCoin', 'MikeTheMug', 'BTCGold', 'Soarcoin', '23 Skidoo', 'Internet of Things', 'AMIS', 'Bitcoin Unlimited (Futures)', 'NxttyACCI', 'Malcoin', 'Forevercoin', 'GoldUnionCoin', 'Fargocoin', 'E-coin', 'Altcoin', 'Internet of People', 'XDE II', 'Yogold', 'Pioneershares', 'TeslaCoilCoin', 'DynamicCoin', 'TaaS', 'Decent (Pre-Launch)', 'Bitgem', 'TechShares', 'Databits', 'Zilbercoin', 'GAYcoin', 'LEOcoin', 'Tattoocoin (Limited Edition)', 'Topaz Coin', 'TROPTIONS', 'ClubCoin', 'EB3 Coin', 'WA Space', 'DIBCOIN', 'Pabyosi Coin (Special)', 'Golos Gold', 'AlpaCoin', 'Tyrocoin', 'DeusCoin', 'Wowecoin', 'InvisibleCoin', 'Fazzcoin', 'AxFunds', 'WavesGo', 'LeCoin', 'Digitalfund', 'CryptoBuck', 'Omicron', 'EDRCoin', 'Elacoin', 'President Johnson', 'DeltaCredits', 'RHFCoin', 'Avoncoin', 'LandCoin', 'Lepaoquan', 'Mind Gene', 'IvugeoCoin', 'International Diamond', 'PiCoin', 'ShellPay', 'KolschCoin', 'GBCGoldCoin', 'Sharkcoin', 'ZSEcoin', 'Dashs', 'CHNCoin', 'Psilocybin', 'President Trump', 'Bitcoin Scrypt', 'First Bitcoin', 'GoldReserve', 'Opal', 'EggCoin', 'Xaucoin', 'MMXVI', 'UltraCoin', 'BagCoin', 'RoyalCoin 2', 'netBit', 'TodayCoin', 'BitcoinFast', 'AvatarCoin', 'Helleniccoin', 'Mavro', 'Quotient', 'UtaCoin', 'Clinton', 'TrickyCoin', 'GameLeagueCoin', 'CBD Crystals', 'RichCoin', 'TeraCoin', 'OCOW', 'Alphabet Coin Fund', 'President Sanders', 'WeAreSatoshi', 'Motocoin', 'Grumfork', 'BestChain', 'Bitcedi', 'RoyalCoin', 'VGINA', 'Digital Bullion Gold', 'UR', 'The Aladin', 'Advanced Internet Blocks', 'Neptune Classic', 'Condensate', 'Skeincoin', 'True Investment Coin', 'Dubstep', 'RubleBit', 'SportsCoin', 'KashhCoin', 'FrankyWillCoin', 'Opescoin', 'Braincoin', 'Quebecoin', 'Cubits', 'T-coin', 'Vsync', 'BlazerCoin', 'GoldMaxCoin', 'Gambleo', 'BitAlphaCoin', 'Lazaruscoin', 'MarxCoin', 'Operand', 'Sakuracoin', 'UGAIN', 'The Vegan Initiative', 'Happy Creator Coin', 'PrismChain', 'AsicCoin', 'DarkLisk', 'Cycling Coin', 'Moneta', 'LAthaan', 'MobileCash', 'TheCreed', 'PinkDog', 'LePen', 'BigLifeCoin', 'LinkedCoin', 'Devcoin', 'Victoriouscoin', 'TeamUp', 'PayPeer', 'Wowcoin', 'MoneyCoin', 'InflationCoin', 'FedoraShare', 'UNCoin', 'PokeCoin', 'Rcoin', 'SoulCoin', 'President Clinton', 'FireFlyCoin', 'CyberCoin', 'X2', 'Aces', 'Cashme', 'SuperTurboStake', 'Safe Trade Coin', 'Global Business Revolution', 'VegasCoin', 'ChoofCoin', 'Yescoin', 'Valorbit', 'Tellurion', 'PabyosiCoin', 'Dimecoin', 'Virtacoin', 'BitCentavo', 'XP', 'Paccoin', 'Bond',];
	...
	exports.autoCompleteAltpocket = autoCompleteAltpocket;
...
/***/ function(module, exports) {
	...
	var mwDataTables = function mwDataTables() {
	  ...
	  $('.highscores-table-wrapper table').DataTable({
	    "aaSorting": [[3, 'desc']]
	  });
	  $('.sold-table-wrapper table').DataTable({
	    "aaSorting": [[0, 'desc']]
	  });
	  var oTable = $('.dataTable').DataTable();
