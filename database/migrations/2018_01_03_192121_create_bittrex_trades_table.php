...
class CreateBittrexTradesTable extends Migration {
	...
	public function up()
	{
		Schema::create('bittrex_trades', function(Blueprint $table)
		{
			$table->increments('id');
			$table->integer('userid')->nullable();
			$table->string('tradeid', 500)->nullable()->unique('tradeid');
